    ...
    public function run()
    {
        $data = [
            [
                ...
                'user_email'    => bin2hex(base64_encode('admin@example.com')),
                'user_phone'    => bin2hex(base64_encode('08123456789')),
                'user_level'    => '0',
                'user_status'   => '1',
                'last_login'    => null,
                'login_from'    => null,
            ...
            [
                ...
                'user_email'     => bin2hex(base64_encode('user@example.com')),
                'user_phone'     => bin2hex(base64_encode('08987654321')),
                'user_level'     => '1',
                'user_status'    => '1',
                'last_login'    => null,
                'login_from'    => null,
            ...
            [
                ...
                'user_email'     => bin2hex(base64_encode('priyo.ardy@schlemmer.co.id')),
                'user_phone'     => bin2hex(base64_encode('087878475545')),
                'user_level'     => '1',
                'user_status'    => '1',
                'last_login'    => null,
                'login_from'    => null,
