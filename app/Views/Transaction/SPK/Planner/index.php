                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered" id="dataTable">
                                    <thead class="text-center">
                                        ...
                                        <th class="align-middle bg-body-secondary">Confirmation Status</th>
                                        <th class="align-middle bg-body-secondary">Reported Date</th>
                                        <th class="align-middle bg-body-secondary">Plan Finish Date</th>
                                        <th class="align-middle bg-body-secondary">Actual Finish Date</th>
