            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item">Repair Reason</li>
                        <li class="breadcrumb-item">List of Repair</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <form id="formData">
                <div class="row g-2">
                        ...
                        <div class="card rounded-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="data_code" id="id_code" class="form-control rounded-0 bg-body-secondary" readonly placeholder="Generate automatically after saving the data">
                                    <div class="invalid-feedback">This field is required</div>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label" for="data_name">Name <strong class="text-danger">*</strong></label>
                                    <input type="text" name="data_name" id="id_name" class="form-control rounded-0" maxlength="150" placeholder="Repair name" autocomplete="off" autofocus>
                                    <div class="invalid-feedback">This field is required</div>
                                </div>
                                <div class="form-group mb-3">
                    ...
                    <div class="col-8">
                        <div class="card rounded-0">
                            <div class="card-header rounded-0 bg-body-secondary">
                                <h3 class="card-title"><i class="bi bi-list-ul"></i>&ensp;List of Repair Reason</h3>
