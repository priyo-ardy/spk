            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item">List of Department</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <form id="formData">
                <div class="row g-2">
                        ...
                        <div class="card rounded-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="data_name" id="data_name" class="form-control rounded-0" maxlength="150" placeholder="Department name" autocomplete="off" autofocus>
                                    <div class="invalid-feedback">This field is required</div>
                                </div>
                                <div class="form-group mb-3">
                    ...
                    <div class="col-8">
                        <div class="card rounded-0">
                            <div class="card-header rounded-0 bg-body-secondary">
                                <h3 class="card-title"><i class="bi bi-list-ul"></i>&ensp;List of Department</h3>
