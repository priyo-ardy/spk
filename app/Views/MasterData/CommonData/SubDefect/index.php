            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item">Sub Defect</li>
                        <li class="breadcrumb-item">List of Sub Defect</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <form id="formData">
                <div class="row g-2">
                        ...
                        <div class="card rounded-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="data_defect" id="data_defect" class="form-control select2 select2bs4 rounded-0" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="data_name" id="data_name" class="form-control rounded-0" maxlength="150" placeholder="Sub defect name" autocomplete="off" autofocus>
                                    <div class="invalid-feedback">This field is required</div>
                                </div>
                                <div class="form-group mb-3">
                    ...
                    <div class="col-8">
                        <div class="card rounded-0">
                            <div class="card-header rounded-0 bg-body-secondary">
                                <h3 class="card-title"><i class="bi bi-list-ul"></i>&ensp;List of Sub Defect</h3>
